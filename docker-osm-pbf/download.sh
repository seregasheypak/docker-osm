...
echo "/home/settings/mapping.yml"
ls -la /home/settings/mapping.yml || true

cat /home/settings/mapping.yml || true
...
#fi
echo "downloading ->  ${BASE_URL}/${CONTINENT}/${COUNTRY}-latest.osm.pbf "
echo "->"
# Download OSM PBF
wget -c --no-check-certificate https://download.geofabrik.de/russia-latest.osm.pbf -O /tmp/${COUNTRY}.pbf
